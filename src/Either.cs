...
/// <see cref="https://github.com/la-yumba/functional-csharp-code"/>
...
namespace advent.of.code
{
	...
	public struct Either<L, R>
	{
		...
		public void Deconstruct(out L left) => (left) = (this.Left);
		public void Deconstruct(out R right) => (right) = (this.Right);
